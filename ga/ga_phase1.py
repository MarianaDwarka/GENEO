...
class GAtelco:
    ...
    # Ejemplo de uso
    # Para ejecutar el Algoritmo Genético y generar el GIF, descomentar estas líneas y proporcionar la ruta adecuada.
        #GAtelco(mu=0.75, eta=0.22, generations=2000).GA()
    #create_gif(r'C:\Users\rlagunaj\Desktop\Hackaton_\dynamic_balance\src\gif', 'output.gif')
# Configuration options for the genetic algorithm

# Option 1 (local): Fewer generations with smaller population but higher mutation rate
# x = GAtelco(generations=1000,
#             router=4,
#             mu=0.8,
#             eta=0.4,
#             people_priority={"tipo1": 200, "tipo2": 2000, "tipo3": 8000}).GA()

# Option 2 (remote): More routers but fewer generations, with lower mutation rate and larger population
# x = GAtelco(generations=100,
#             router=7,
#             eta=0.3,
